$(document).ready(function () {
  ...
  $(".js-slider-main").slick({
    ...
    pauseOnHover: true,
    prevArrow:
      '<button type="button" class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" fill="none"><path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="m11.288 15.105-4.89-4.89a1.49 1.49 0 0 1 0-2.1l4.89-4.89"/></svg></button>',
    nextArrow:
      '<button type="button" class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" fill="none"><path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="m6.712 3.225 4.89 4.89a1.49 1.49 0 0 1 0 2.1l-4.89 4.89"/></svg></button>',
  });
  // //end main slider
  ...
  $(".slider-main-product-images-nav").slick({
    ...
    prevArrow:
      '<button type="button" class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"><path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="m3.06 11.288 4.89-4.89a1.49 1.49 0 0 1 2.1 0l4.89 4.89"/></svg></button>',
    nextArrow:
      '<button type="button" class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"><path  stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="m14.94 6.712-4.89 4.89a1.49 1.49 0 0 1-2.1 0l-4.89-4.89"/></svg></button>',
    responsive: [
      {
        breakpoint: 1280,
        settings: {
  ...
  $(".slider-main-product-images, .slider-main-product-images-nav").each(
    function () {
  ...
  if ($(".main-product-info__col-1").length) {
    if (window.innerWidth > 999) {
      $(".main-product-info__col-2").height(
        $(".main-product-info__col-1").height()
      );
    }
  }
  ...
  $(".js-form-register").each(function () {
    $(this).validate({
      ...
      messages: {
        name: {
          lettersonly: "Введіть Ім’я кирилицею",
          required: "Введіть ваш Ім’я",
        },
        lastname: {
          lettersonly: "Введіть Прізвище кирилицею",
          required: "Введіть ваш Прізвище",
        },
  ...
  $(".js-form-checkout").each(function () {
    $(this).validate({
      ...
      messages: {
        ...
        promocode: "Промо-код не знайдено",
        certificate: "Сертифікат не знайдено",
        points: "У вас не достатньо балів для списання",
      },
      submitHandler: function (form) {
        form.submit();
        // $.fancybox.close();
  ...
  function runIntlTelInput(element, countryCallback) {
    let iti = window.intlTelInput(element, {
      ...
      customPlaceholder: function (
        ...
        if (selectedCountryData.iso2 == "ua") return "(0__) ___-__-__";
