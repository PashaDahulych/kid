...
class Popup {
    ...
    open(selectorValue) {
        if (bodyLockStatus) {
            ...
            if (this.options.focusDisable)
                this.disableFocusableElements(this.targetOpen.element)
    ...
    close(selectorValue) {
        ...
        if (this.options.focusDisable)
            this.enableFocusableElements(this.previousOpen.element)
    ...
    // }
    disableFocusableElements(popupElement) {
    ...
    enableFocusableElements(popupElement) {
        const focusableElements = popupElement.querySelectorAll(
            this.focusableElements
        )
        focusableElements.forEach((element) => {
